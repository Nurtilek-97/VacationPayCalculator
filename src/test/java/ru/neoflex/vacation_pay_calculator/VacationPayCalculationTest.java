...
public class VacationPayCalculationTest {
    ...
    private final BigDecimal testAverageSalaryPerYear = new BigDecimal("50000.00");
    ...
    void calculationOfVacationPayForEmployeeUsingSimpleQueryTest() throws Exception {
        ...
        assertEquals(BigDecimal.valueOf(44539.40), actual.stripTrailingZeros());
    }

    @Test
    void calculationOfVacationPayForEmployeeUsingQueryWithDateTest() throws Exception {

        LocalDate testStartVacationDate = LocalDate.of(2025, 3, 30);
        ...
        assertEquals(BigDecimal.valueOf(31177.08), actual.stripTrailingZeros());
    }
}
